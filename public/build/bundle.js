...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 10, 1, 176);
    			attr_dev(input0, "type", "text");
    			add_location(input0, file, 13, 1, 333);
    			attr_dev(input1, "type", "text");
    			add_location(input1, file, 14, 1, 377);
    			attr_dev(input2, "type", "text");
    			add_location(input2, file, 15, 1, 420);
    			attr_dev(main, "class", "svelte-1tky8bj");
    			add_location(main, file, 8, 0, 135);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*color*/ 4) set_data_dev(t2, /*color*/ ctx[2]);
    			...
    			if (dirty & /*color*/ 4 && input2.value !== /*color*/ ctx[2]) {
    				set_input_value(input2, /*color*/ ctx[2]);
    			}
    		},
    		i: noop,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ color, firstName, lastName, fullName });
